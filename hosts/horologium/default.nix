{ config, pkgs, lib, ... }:
{
  ...
  networking = {
    ...
    firewall = {
      enable          = true;
      allowedTCPPorts = [ 8096 8920 7359 9696 8989 7878 6767 8080 5055 11434];
  ...
  # === NVIDIA (RTX 3060 — Ollama only, Jellyfin stays on QuickSync) ===
hardware.nvidia = {
  modesetting.enable = true;
  powerManagement.enable = true;      # lets GPU power down when idle
  open = false;
